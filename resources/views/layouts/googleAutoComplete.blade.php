...
<body>
    ...
    function initAutocomplete() {
      ...
      // autocomplete.setFields(['address_component']); -- I don't need this function
    ...
    function fillInAddress() {
      ...
      document.getElementById('vLat').value = place.geometry.location.lat();
      document.getElementById('vLon').value = place.geometry.location.lng();
